                        ...
                        new Column(new ColumnProps().centerHorizontally().width(400)
                                ...
                                .children(
                                        new Image("assets/app_banner.png", new ImageProps().width(400).height(200).preserveRatio(true))
                                                .ref(logoRef),
                                        //new Text("Gobitech", new TextProps().fontSize(ThemeManager.theme().typography().title()).bold().color(ThemeManager.theme().colors().secondary())),
                                        new Text("Balanças Gobitech - Sistema de pesagem para báscula rodoviária. Cadastre clientes, produtos e registre pesagens.",
    ...
    public Component textRow() {
        return new Row(new RowProps().width(200).maxWidth(300).centerHorizontally().bgColor(ThemeManager.theme().colors().border()))
                .children(
                        ...
                        new Text(" gestor", new TextProps().fontSize(ThemeManager.theme().typography().body()).bold().color("#fff")),
